...
Ten years later it turned out that world domination had to be slightly
delayed.  Although Act and the French mongers never stopped to help
organize conferences, the software had accumulated a certain amount of
patina.  Several teams and individuals have started working on the
software, and here's the result: Act is still breathing.
...
=head2 Translations
  ...
  de: Thomas Klausner, Renée Bäcker
  es: Enrique Nell
  he: Uri Bruck
